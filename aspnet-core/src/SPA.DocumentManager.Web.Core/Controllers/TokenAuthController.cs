...
using Abp.UI;
using SPA.DocumentManager.Authentication.External;
...
using SPA.DocumentManager.Models.TokenAuth;
using SPA.DocumentManager.MultiTenancy;

namespace SPA.DocumentManager.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : DocumentManagerControllerBase
    {
